...
pub const struct_WrenVM = opaque {
    pub const wrenFreeVM = __root.wrenFreeVM;
    pub const wrenCollectGarbage = __root.wrenCollectGarbage;
    pub const wrenInterpret = __root.wrenInterpret;
    pub const wrenMakeCallHandle = __root.wrenMakeCallHandle;
    pub const wrenCall = __root.wrenCall;
    pub const wrenReleaseHandle = __root.wrenReleaseHandle;
    pub const wrenGetSlotCount = __root.wrenGetSlotCount;
    pub const wrenEnsureSlots = __root.wrenEnsureSlots;
    pub const wrenGetSlotType = __root.wrenGetSlotType;
    pub const wrenGetSlotBool = __root.wrenGetSlotBool;
    pub const wrenGetSlotBytes = __root.wrenGetSlotBytes;
    pub const wrenGetSlotDouble = __root.wrenGetSlotDouble;
    pub const wrenGetSlotForeign = __root.wrenGetSlotForeign;
    pub const wrenGetSlotString = __root.wrenGetSlotString;
    pub const wrenGetSlotHandle = __root.wrenGetSlotHandle;
    pub const wrenSetSlotBool = __root.wrenSetSlotBool;
    pub const wrenSetSlotBytes = __root.wrenSetSlotBytes;
    pub const wrenSetSlotDouble = __root.wrenSetSlotDouble;
    pub const wrenSetSlotNewForeign = __root.wrenSetSlotNewForeign;
    pub const wrenSetSlotNewList = __root.wrenSetSlotNewList;
    pub const wrenSetSlotNewMap = __root.wrenSetSlotNewMap;
    pub const wrenSetSlotNull = __root.wrenSetSlotNull;
    pub const wrenSetSlotString = __root.wrenSetSlotString;
    pub const wrenSetSlotHandle = __root.wrenSetSlotHandle;
    pub const wrenGetListCount = __root.wrenGetListCount;
    pub const wrenGetListElement = __root.wrenGetListElement;
    pub const wrenSetListElement = __root.wrenSetListElement;
    pub const wrenInsertInList = __root.wrenInsertInList;
    pub const wrenGetMapCount = __root.wrenGetMapCount;
    pub const wrenGetMapContainsKey = __root.wrenGetMapContainsKey;
    pub const wrenGetMapValue = __root.wrenGetMapValue;
    pub const wrenSetMapValue = __root.wrenSetMapValue;
    pub const wrenRemoveMapValue = __root.wrenRemoveMapValue;
    pub const wrenGetVariable = __root.wrenGetVariable;
    pub const wrenHasVariable = __root.wrenHasVariable;
    pub const wrenHasModule = __root.wrenHasModule;
    pub const wrenAbortFiber = __root.wrenAbortFiber;
    pub const wrenGetUserData = __root.wrenGetUserData;
    pub const wrenSetUserData = __root.wrenSetUserData;
};
pub const WrenVM = struct_WrenVM;
pub const struct_WrenHandle = opaque {};
pub const WrenHandle = struct_WrenHandle;
pub const WrenReallocateFn = ?*const fn (memory: ?*anyopaque, newSize: usize, userData: ?*anyopaque) callconv(.c) ?*anyopaque;
...
pub const WrenResolveModuleFn = ?*const fn (vm: ?*WrenVM, importer: [*c]const u8, name: [*c]const u8) callconv(.c) [*c]const u8;
pub const WrenLoadModuleCompleteFn = ?*const fn (vm: ?*WrenVM, name: [*c]const u8, result: struct_WrenLoadModuleResult) callconv(.c) void;
...
pub const WrenLoadModuleFn = ?*const fn (vm: ?*WrenVM, name: [*c]const u8) callconv(.c) WrenLoadModuleResult;
pub const WrenBindForeignMethodFn = ?*const fn (vm: ?*WrenVM, module: [*c]const u8, className: [*c]const u8, isStatic: bool, signature: [*c]const u8) callconv(.c) WrenForeignMethodFn;
pub const WrenWriteFn = ?*const fn (vm: ?*WrenVM, text: [*c]const u8) callconv(.c) void;
...
pub const WrenErrorFn = ?*const fn (vm: ?*WrenVM, @"type": WrenErrorType, module: [*c]const u8, line: c_int, message: [*c]const u8) callconv(.c) void;
pub const WrenForeignClassMethods = extern struct {
    allocate: WrenForeignMethodFn = null,
    finalize: WrenFinalizerFn = null,
};
pub const WrenBindForeignClassFn = ?*const fn (vm: ?*WrenVM, module: [*c]const u8, className: [*c]const u8) callconv(.c) WrenForeignClassMethods;
pub const WrenConfiguration = extern struct {
    ...
    userData: ?*anyopaque = null,
    pub const wrenInitConfiguration = __root.wrenInitConfiguration;
    pub const wrenNewVM = __root.wrenNewVM;
};
...
pub const va_start = @compileError("unable to translate macro: undefined identifier `__builtin_va_start`"); // /home/moka/.local/share/mise/installs/zig/master/lib/compiler/aro/include/stdarg.h:12:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`"); // /home/moka/.local/share/mise/installs/zig/master/lib/compiler/aro/include/stdarg.h:14:9
pub const va_arg = @compileError("unable to translate macro: undefined identifier `__builtin_va_arg`"); // /home/moka/.local/share/mise/installs/zig/master/lib/compiler/aro/include/stdarg.h:15:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /home/moka/.local/share/mise/installs/zig/master/lib/compiler/aro/include/stdarg.h:18:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /home/moka/.local/share/mise/installs/zig/master/lib/compiler/aro/include/stdarg.h:22:9
...
pub const offsetof = @compileError("unable to translate macro: undefined identifier `__builtin_offsetof`"); // /home/moka/.local/share/mise/installs/zig/master/lib/compiler/aro/include/stddef.h:18:9
...
pub const WREN_VERSION_NUMBER = ((WREN_VERSION_MAJOR * __helpers.promoteIntLiteral(c_int, 1000000, .decimal)) + (WREN_VERSION_MINOR * @as(c_int, 1000))) + WREN_VERSION_PATCH;
pub const WREN_API = "";
